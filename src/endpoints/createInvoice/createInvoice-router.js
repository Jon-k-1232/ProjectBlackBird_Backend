...
const insertInvoice = async (invoiceObject, nextInvoiceNumber, db) => {
  const invoice = {
    company: invoiceObject.company,
    invoiceNumber: nextInvoiceNumber,
    contactName: invoiceObject.contactName,
    address1: !invoiceObject.address1 ? invoiceObject.contactName : invoiceObject.address1,
    address2: !invoiceObject.address2 ? invoiceObject.address3 : invoiceObject.address2,
    address3: !invoiceObject.address3 ? invoiceObject.address4 : invoiceObject.address3,
    address4: !invoiceObject.address4 ? invoiceObject.address5 : invoiceObject.address4,
    address5: !invoiceObject.address5 ? '' : invoiceObject.address5,
    beginningBalance: invoiceObject.beginningBalance,
    totalPayments: invoiceObject.totalPayments,
    totalNewCharges: invoiceObject.totalNewCharges,
    endingBalance: invoiceObject.endingBalance,
    unPaidBalance: invoiceObject.unPaidBalance,
    invoiceDate: invoiceObject.invoiceDate,
    paymentDueDate: invoiceObject.paymentDueDate,
    dataEndDate: invoiceObject.dataEndDate,
  };
...
const insertInvoiceDetails = (invoiceObject, invoiceNumber, db) => {
  invoiceObject.newChargesRecords.forEach(async transaction => {
    const invoiceDetail = {
      ...
      detailType: transaction.transactionType,
      jobDescription: transaction.description,
      charges: transaction.totalTransaction,
      discount: transaction.discount,
      writeOff: transaction.transactionType === 'Write Off' ? transaction.totalTransaction : 0,
      net: transaction.totalTransaction,
      payment: transaction.transactionType === 'Payment' ? transaction.totalTransaction : 0,
    };
